...
Each list stores one name using the append() function.
...
# "Push" data into them
p1.append("S Abhilash")
p2.append("Rizwan K A")
p3.append("Rashmi Deepak Naik")
...
Basic output formatting in Python
